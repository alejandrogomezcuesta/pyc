...
En los ejercicios de [práctica con cinco ejercicios independientes](ejercicios-godot.md), el botón emite la señal `pressed`. El script conecta esa señal con una función, lee el texto de los `LineEdit`, realiza la operación y cambia el texto del `Label` de resultado.
